                ...
                <Col md={4}>
                    ...
                    <Card className="text-center border-0">
                        <Card.Body className='perfil'>
                            ...
                            <p className="text-muted">"Eu sou muito inteligente também, porque eu quero!"</p>
                ...
                <Col md={8}>
                    <Card className="shadow-sm mb-4">
                        <Card.Body>
                            ...
                            <p><strong>Email:</strong> tadalafela@example.com</p>
                            <p><strong>Data de nascimento:</strong> 01 de Janeiro de 1990</p>
                            <p><strong>Localização:</strong> Campo Mourão, Paraná, Brasil</p>
                        </Card.Body>
                    </Card>
